...
<title>EventCore · Nuevo Participante</title>
  ...
  <div class="main">
    <div class="con">
      <div style="margin-bottom:30px;display:flex;justify-content:space-between;align-items:center">
        <h2 style="font-weight:200;font-size:28px">Nuevo <strong>Participante</strong></h2>
        ...
        <form method="POST">
          <div class="form-row">
            <div class="form-group">
              <label>Nombres</label>
              <input type="text" name="nombres" class="form-control" required value="<?= $e($_POST['nombres'] ?? '') ?>" placeholder="Ej. Pedro">
            </div>
            <div class="form-group">
              <label>Apellidos</label>
              <input type="text" name="apellidos" class="form-control" required value="<?= $e($_POST['apellidos'] ?? '') ?>" placeholder="Ej. Quispe">
            </div>
          </div>
          <div class="form-group">
            <label>Correo Electrónico</label>
            <input type="email" name="email" class="form-control" required value="<?= $e($_POST['email'] ?? '') ?>" placeholder="Ej. pedro@email.com">
          </div>
          <div class="form-row">
            <div class="form-group">
              <label>Teléfono</label>
              <input type="text" name="telefono" class="form-control" value="<?= $e($_POST['telefono'] ?? '') ?>" placeholder="Ej. 71234567">
            </div>
            <div class="form-group">
              <label>Documento de Identidad</label>
              <input type="text" name="documento_id" class="form-control" value="<?= $e($_POST['documento_id'] ?? '') ?>" placeholder="Ej. 9876543">
            </div>
          </div>
