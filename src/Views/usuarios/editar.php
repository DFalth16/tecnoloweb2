...
<title>EventCore · Editar Usuario</title>
  ...
  <div class="main">
    <div class="con">
      <div style="margin-bottom:30px;display:flex;justify-content:space-between;align-items:center">
        <h2 style="font-weight:200;font-size:28px">Editar <strong>Usuario</strong></h2>
        ...
        <form method="POST">
          <div class="form-row">
            <div class="form-group">
              <label>Nombres</label>
              <input type="text" name="nombres" class="form-control" required value="<?= $e($usuario['nombres']) ?>">
            </div>
            <div class="form-group">
              <label>Apellidos</label>
              <input type="text" name="apellidos" class="form-control" value="<?= $e($usuario['apellidos']) ?>">
            </div>
          </div>
          <div class="form-group">
          ...
          <div class="form-row">
            ...
            <div class="form-group">
              ...
              <select name="id_rol" class="form-control" required>
                ...
                <option value="<?= $r['id_rol'] ?>" <?= ($usuario['id_rol'] == $r['id_rol']) ? 'selected' : '' ?>><?= $e($r['nombre_rol']) ?></option>
                <?php endforeach; ?>
              </select>
            </div>
          </div>
